...
1. Select the checkbox of the results that shows the *"-file c2.ps1"* any of the files appeared in the result.
...
1. The search job creates a new table with your results as soon as they arrive If asked enter one unique table name. The results can be consulted from the *Saved Searches* tab.
