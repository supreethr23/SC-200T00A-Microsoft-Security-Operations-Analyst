...
1. Under **Standard protection**, select **Manage protection settings**. **Hint:** If you see this option grayed out, refresh your browser using **Ctrl+F5**.
    ...
    >**Note:** After clicking on **Manage protection settings**, This might need 1-2 hours to load the content, meanwhile we can start testing **Module 3 exercise 1** (Page 5 of the lab guide) and after 1-2 hours back to the same page and might need to sign out of Microsoft defender and sign in again and then try repeating the steps again to move forward. 
